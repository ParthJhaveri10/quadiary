            ...
            <div className={`max-w-md w-full ${themeStyles.glass.card} p-8 relative z-10`}>
                <div className="text-center mb-8">
                    <div className="mb-6">
                        <div className="w-20 h-20 bg-gradient-to-br from-[#66FCF1] to-[#45A29E] rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-[#66FCF1]/25 transition-transform duration-300 hover:scale-105">
                            <svg className="w-10 h-10 text-[#0B0C10]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                            </svg>
                        </div>
                    </div>
                    <h1 className={`text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r ${themeStyles.gradients.title} mb-3`}>Welcome Back</h1>
                    <p className={`${themeStyles.text.secondary} text-lg`}>Sign in to continue your rating journey</p>
                </div>

                {error && (
                    <div className="bg-[#66FCF1]/10 border border-[#66FCF1]/30 rounded-xl p-4 mb-6 backdrop-blur-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-5">
                        <div>
                            <label htmlFor="email" className="block text-[#C5C6C7] text-sm font-semibold mb-2">
                                Email Address
                            </label>
                            <input
                                type="email"
                                ...
                                required
                                className="w-full px-4 py-3.5 bg-[#C5C6C7]/5 border border-[#C5C6C7]/20 rounded-xl 
                                         text-[#C5C6C7] placeholder-[#C5C6C7]/60 focus:outline-none 
                                         focus:ring-2 focus:ring-[#66FCF1]/50 focus:border-[#66FCF1]/50 
                                         backdrop-blur-sm transition-all duration-200
                                         hover:bg-[#C5C6C7]/[0.08] hover:border-[#C5C6C7]/30"
                                placeholder="Enter your email"
                            />
                        </div>

                        <div>
                            <label htmlFor="password" className="block text-[#C5C6C7] text-sm font-semibold mb-2">
                                Password
                            </label>
                            <input
                                type="password"
                ...
                <div className="mt-8 text-center">
                    <p className="text-[#C5C6C7]">
                        ...
                        <Link 
                            to="/signup" 
                            className="text-[#66FCF1] hover:text-[#66FCF1]/90 font-semibold transition-colors duration-200 hover:underline decoration-2 underline-offset-2"
                        >
                            Sign up here
                        </Link>
                    </p>
